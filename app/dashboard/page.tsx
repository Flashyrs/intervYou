            ...
            {incoming.map((invite) => (
              <div key={invite.tempId} className="border border-gray-200 dark:border-zinc-700 rounded-lg p-4 bg-gray-50 dark:bg-zinc-800 shadow-sm">
                ...
                <div className="flex gap-3">
                  <button
                    className="flex-1 px-4 py-2 bg-black text-white dark:bg-white dark:text-black rounded hover:bg-gray-800 dark:hover:bg-zinc-200 transition text-sm font-medium"
